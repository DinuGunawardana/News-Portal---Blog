...
?>
<h2><?php echo htmlentities($row['category']);?>  </h2>  
          <div class="card mb-4" style="width:600px; ">
       <img class="card-img-top" style="width: 100px; height: 100px; margin-left: 50px;" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
