...
?>
 ...
 <img class="img-fluid rounded" style="width: 250px; height: 250px;" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
